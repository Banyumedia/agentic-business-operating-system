...
- **Next:** T-43 (`ContractScreen`) kini `READY`. Ia tidak menyentuh migration, jadi boleh dikerjakan langsung; file targetnya (`DynamicMenuRegistry`, layar baru) tidak bertabrakan dengan WIP writer lain.
