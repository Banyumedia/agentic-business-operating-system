        ...
        <div class="mx-auto w-full max-w-2xl overflow-hidden rounded-[var(--erp-radius-lg)] border border-[var(--erp-border)] bg-[var(--erp-bg-secondary)] shadow-[var(--erp-card-shadow)]">
            <div class="flex items-center border-b border-[var(--erp-border)]">
                <div class="relative min-w-0 flex-1">
                    <svg wire:loading.remove wire:target="search" class="pointer-events-none absolute left-4 top-4 h-6 w-6 text-[var(--erp-text-muted)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                        <circle cx="11" cy="11" r="7" />
                        <path stroke-linecap="round" d="m20 20-4-4" />
                    </svg>
                    <svg wire:loading wire:target="search" class="pointer-events-none absolute left-4 top-4 h-6 w-6 animate-spin text-[var(--erp-accent)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="max-h-96 overflow-y-auto p-2" aria-live="polite">
                <div wire:loading.flex wire:target="search" class="items-center justify-center p-8 text-[var(--erp-text-muted)]">
                    Mencari...
                </div>
